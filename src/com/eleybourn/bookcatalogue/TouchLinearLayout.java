...
import com.eleybourn.bookcatalogue.TouchLinearLayout.DragListener;
import com.eleybourn.bookcatalogue.TouchLinearLayout.DropListener;
import com.eleybourn.bookcatalogue.TouchLinearLayout.RemoveListener;
...
//									dragger.getDrawingRect(r);
	...
	/*
	 * Restore size and visibility for all items
	 */
...
//									// end hack
//							}
//							// TODO layoutChildren(); // force children to be recreated where needed
//							v = getChildAt(i);
//							if (v == null) {
//									break;
//							}
	...
	private void doExpansion() {
			int childnum = mDragPos;
			if (mDragPos > mFirstDragPos) {
					childnum++;
			}

			View first = getChildAt(mFirstDragPos);
					...
					switch (action) {
							...
							case MotionEvent.ACTION_CANCEL:
									...
									if (mRemoveMode == SLIDE_RIGHT && ev.getX() > r.left+(r.width()*3/4)) {
										...
										// TODO getCount()
										if (mDropListener != null && mDragPos >= 0 && mDragPos < getChildCount()) {
									...
									if (itemnum >= 0) {
											...
											if (speed != 0) {
													...
													if (ref == AdapterView.INVALID_POSITION) {
														...
														// TODO: getDividerHeight()
															ref = pointToPosition(0, mHeight / 2 + 0 + 64);
													}
